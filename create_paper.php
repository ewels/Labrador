...
<!-- E-mail Log In Modal' -->
		<div id="emailLoginModal" class="modal hide fade" tabindex="-1" role="dialog">
			...
			<div class="modal-body">
					    <?php if(!$email_validate) { ?>
					    <div class="alert alert-error"><strong>Error</strong> Sorry, that e-mail address doesn't look right..</div>
<?php } // end of validate error check ?>
